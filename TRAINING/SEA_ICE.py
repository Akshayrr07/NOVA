...
data_url = 'DATASETS\sea_ice_extent.csv'  # Replace with actual data URL
...
# Train the model
sea_ice_model = RandomForestRegressor()
sea_ice_model.fit(X_train, y_train)

# Save the model
joblib.dump(sea_ice_model, 'sea_ice_model.pkl')
